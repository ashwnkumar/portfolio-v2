...
function Contact() {
  ...
  return (
    <div
      ...
      id="contact"
    >
      <div className="p-5 h-max max-w-7xl flex flex-col gap-8 w-full px-4 sm:px-8 lg:px-16">
        ...
        <a
          className="flex items-center justify-center gap-3 text-text border border-text text-lg sm:text-2xl rounded-full w-max px-6 py-3 hover:scale-105 hover:text-background hover:bg-text transition-all duration-300"
        ...
        <p className="text-xl sm:text-2xl lg:text-3xl text-subtext font-light mt-8">
        ...
        <div className="flex items-center gap-4 mt-4 flex-wrap">
          {socialLinks.map((link) => (
            <a
              className="flex items-center text-3xl lg:text-4xl justify-center gap-2 text-text p-4 rounded-full hover:scale-110 hover:text-background hover:bg-text transition-all duration-300"
              href={link.link}
              key={link.name}
